...
public class Q1620 {
    public static void main(String[] args) throws IOException {
        ...
        Map<String, String> poketmonDict1 = new HashMap<String, String>();
        Map<String, String> poketmonDict2 = new HashMap<String, String>();
        ...
        for (int i=1;i<=n;i++){
            ...
            poketmonDict1.put(String.valueOf(i), Q);
            poketmonDict2.put(Q, String.valueOf(i));
        }
        ...
        for (int i=0;i<m;i++){
            ...
            if (poketmonDict1.containsKey(Question)){
                System.out.println(poketmonDict1.get(Question));
            }

            if (poketmonDict2.containsKey(Question)){
                System.out.println(poketmonDict2.get(Question));
            }
        }
    }
}
