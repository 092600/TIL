...
//2 초	256 MB	61003	28394	20323	45.861%
//문제
...
//
//셋째 줄에는 M(1 ≤ M ≤ 500,000)이 주어진다. 넷째 줄에는 상근이가 가지고 있는 숫자 카드인지
// 아닌지를 구해야 할 M개의 정수가 주어지며, 이 수는 공백으로 구분되어져 있다. 이 수도 -10,000,000보다
// 크거나 같고, 10,000,000보다 작거나 같다
//
//출력
...
public class Q10815 {
    public static void main(String[] args) throws IOException {
        ...
        Map<String,Integer> myCards = new HashMap<String, Integer>();
        Map<String,Integer> cards = new HashMap<String, Integer>();

        String[] tmpList = br.readLine().split(" ");
